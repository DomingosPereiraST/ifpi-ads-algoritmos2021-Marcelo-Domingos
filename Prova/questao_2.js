...
if  (valor_vendas<=5000 && valor_vendas>0){
    ...
    console.log("Saldo: R$", (valor_vendas+salario).toFixed(2))
    ...
    console.log("Sua comissão é de: R$", percentual.toFixed(2))
    console.log("Saldo: R$",(valor_vendas+percentual+salario).toFixed(2))
    ...
    console.log("Sua comissão é de: R$", percentual.toFixed(2))
    console.log("Sua comissão bonus é de: R$", percentual_bonus.toFixed(2))
    console.log("Saldo: R$", (valor_vendas+percentual+percentual_bonus+salario).toFixed(2))
